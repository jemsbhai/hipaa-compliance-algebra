...
\end{axis}
\end{tikzpicture}
\caption{Progressive de-identification of a Synthea patient record. Each identifier removal increases $l_{\text{PHI}}$ by approximately $19\times$ (ratio of absent to present opinion: $0.95/0.05$). Starting from 6 identifiers ($l = 8.44 \times 10^{-9}$), full removal yields $l = 0.397$ ($= 0.95^{18}$). Theory-validated at every step.}
