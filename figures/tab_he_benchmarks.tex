...
\begin{table}[t]
\centering
\caption{CKKS benchmark for Jurisdictional Meet: max absolute error vs.\ plaintext over 1000 random opinion pairs; latency excludes one-time key generation (204\,ms).}
...
\quad Encrypt (2 opinions) & 19.26\,ms (p50) & n/a \\
\quad Compute ($J_\sqcap$) & 6.06\,ms (p50) & n/a \\
\quad Decrypt + normalize & 1.93\,ms (p50) & n/a \\
\quad Total & 27.34\,ms (p50) & $< 100$\,ms \\
\quad Plaintext baseline & 0.002\,ms (p50) & n/a \\
\quad Overhead factor & $15{,}186\times$ & n/a \\
\midrule
