...
\end{axis}
\end{tikzpicture}
\caption{Expert Determination vs.\ Safe Harbor de-identification confidence across trust levels. Expert exceeds Safe Harbor when $t > p^{n} q^{18-n}/l_{\text{expert}}$ (Theorem~2): $t^* = 0.441$ with all 18 identifiers removed at $p = 0.95$, and $t^* = 0.724$ for the Synthea profile ($n = 6$, $q = 0.99$).}
